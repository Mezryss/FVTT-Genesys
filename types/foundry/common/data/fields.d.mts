...
export type FlagField<TSourceProp extends { [K in string]?: Record<string, unknown> } = { [K in string]?: Record<string, unknown> }, TModelProp = TSourceProp, TNullable extends boolean = false> = ObjectField<
	TSourceProp,
	TModelProp,
	TNullable
>;
