...
declare global {
	...
	type PreCreate<T extends foundry.abstract.DocumentSource> = T extends { name: string; type: string } ? Omit<DeepPartial<T>, 'name' | 'type'> & { name: string; type: T['type'] } : DeepPartial<T>;
