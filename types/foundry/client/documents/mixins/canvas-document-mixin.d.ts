...
declare global {
	 ...
	 * @mixin
	 */
	function CanvasDocumentMixin<TDocument extends typeof foundry.abstract.Document, TLayer extends PlaceablesLayer>(Base: TDocument): CanvasDocumentMixin<TDocument, TLayer>;

	type CanvasDocumentMixin<TDocument extends typeof foundry.abstract.Document, TLayer extends PlaceablesLayer> = TDocument & {
		new (...args: any[]): CanvasDocument<InstanceType<TDocument>, TLayer> & InstanceType<TDocument>;
	};

	class CanvasDocument<TDocument extends foundry.abstract.Document = foundry.abstract.Document, TLayer extends PlaceablesLayer = PlaceablesLayer<any>> extends ClientDocument<TDocument> {
	...
	interface CanvasDocument<TDocument extends foundry.abstract.Document = foundry.abstract.Document, TLayer extends PlaceablesLayer = PlaceablesLayer<any>> extends ClientDocument<TDocument> {
		x: number;
		y: number;
		hidden: boolean;
	}
