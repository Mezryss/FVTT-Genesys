...
declare global {
     ...
     */
	class ActorSheet<TActor extends Actor = Actor, TItem extends Item = Item> extends DocumentSheet<TActor, ActorSheetOptions> {
		 ...
		 */
		protected _onDropActiveEffect<D extends ActiveEffect>(event: ElementDragEvent, data?: DropCanvasData<'ActiveEffect', D>): Promise<D | void>;
